...
*********************************************************************************************************
*	函 数 名: timing
*	功能说明: 用于判断是否达到指定的时间间隔
*	形    参:  无
*	返 回 值: TRUE:时间到; FALSE:时间间隔未到
*********************************************************************************************************
*/
uint8_t timing(uint32_t starting_time, uint32_t interval)
{
	if(g_iRunTime-starting_time>interval)	return TRUE;
	else									                return FALSE;
}
