...
#define VS1053_CS_0()	GPIOA->BRR = GPIO_Pin_3
#define VS1053_CS_1()	GPIOA->BSRR = GPIO_Pin_3

#define VS1053_DS_0()	GPIOA->BRR = GPIO_Pin_1
#define VS1053_DS_1()	GPIOA->BSRR = GPIO_Pin_1

/* VS1053_DREQ = PA4 */
#define VS1053_IS_BUSY()	((GPIOA->IDR & GPIO_Pin_4) == 0)
...
void vs1053_Init(void)
{
	...
	/*
		...
		PA7/SPI1_MOSI ==> SI
		PA5/SPI1_SCK  ==> SCLK
		PA3           ==> XCS\     (片选, 和LED4复用，访问VS1003B时，LED4会闪烁)
		PA4           <== DREQ
		PA1           ==> XDCS/BSYNC   (数据和命令选择)
		
	*/
	/* 打开相关模块的时钟 */
	RCC_APB2PeriphClockCmd(RCC_APB2Periph_GPIOA | RCC_APB2Periph_GPIOB| RCC_APB2Periph_GPIOF | RCC_APB2Periph_GPIOF| RCC_APB2Periph_AFIO, ENABLE);
